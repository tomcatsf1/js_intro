...
// Console.log the length of the arrray*/ //not sure what asking!!

var peanutsGang = ['charlieBrown', 'snoopy', 'bird', 'dirtbag', 'girl'];
...
var blockhead = 'you are a blockhead';
var phrase = (character + '' + blockhead);
console.log(phrase);
...
var myFav = 'My favorite peanuts character is ' + nuts + '.';
console.log(myFav);
...
var currentBal = 8000;
var deposit = 1000;
var newsavingsBal = currentBal + deposit;
...
var withDrawl = 3000;
var newsavingsBal = newsavingsBal - withDrawl;
console.log(newsavingsBal);
...
var bitcoinBalance = 2;
var newbitcoinBalance = bitcoinBalance + 1;
...
const evenAccount = newsavingsBal%2;
console.log(evenAccount);
var prize = 500;
var savingsTotal = evenAccount + newsavingsBal + prize;
...
var tax = .30;
var prizeTotal = prize * tax;
console.log(prizeTotal)
var newsavingsBal = newsavingsBal - prizeTotal;
console.log(newsavingsBal);
...
var intRate = .02;
var quarterlyInterest = intRate / 4;
var intEarned = newsavingsBal * quarterlyInterest;
...
var newbitcoinBalance = newbitcoinBalance - 1;
console.log(newbitcoinBalance);
